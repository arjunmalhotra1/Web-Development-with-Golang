// State is like persistence sought of awareness of who is communicating with the server.
...
// Before we do that we will see how to pass the data, so we can pass data through the url.
// Or when a user submits a form through the body.
// Also we will learn about re-directs.
// Finally we will see cookies and sessions.