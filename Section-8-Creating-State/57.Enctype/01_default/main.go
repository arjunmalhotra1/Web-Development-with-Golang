...
func foo(res http.ResponseWriter, req *http.Request) {
	...
	// We can use the Read method available on req.Body to read into the byte slice the data and turn it into
	// a string. Finally pass in the body to the template.
	req.Body.Read(bs)
